...
Answer **HOW-KEYWORD-MAJOR-GUIDANCE** questions with fast-fit major guidance anchored in curriculum and career evidence.

### CANONICAL INPUT (TARGET CONTRACT)

- Same target contract as `how_major_guidance`: `answer.kind = "roadmap"`.
...
- Keep claims evidence-grounded.
- No deterministic guarantees about salary or employability.
