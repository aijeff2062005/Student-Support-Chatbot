...
Answer **HOW-COURSE-ROADMAP** questions by turning course evidence into a stepwise learning plan.
...
1. STARTING POINT
- Summarize course scope and credit load.

2. LEARNING SEQUENCE
- Order preparation from prerequisites -> core topics -> practice focus.

3. END STATE
- Close with expected outcomes and transferable skills.

### SPECIAL RULES

- Keep roadmap concrete and sequence-based.
- Do not include unsupported milestone dates.

### CONSTRAINTS

- Use only retrieved course evidence.
- Avoid generic, non-course-specific advice blocks.
